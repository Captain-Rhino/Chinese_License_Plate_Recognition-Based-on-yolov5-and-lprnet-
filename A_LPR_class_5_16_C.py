...
import cv2
import torch
from A_LPRNet_test_5_16_C import build_lprnet
import time
import os
...
path = r'G:\yolo-train\yolov5-master\demo_up.pth'  # ./weights/LPR_mix.pth ./weights/LPR_demo.pth
...
img_dir = r'G:\yolo-train\yolov5-master\data\test_data'
false = 0
...
class LicensePlateRecognizer:
    ...
    def __init__(self, model_path='demo_up.pth'):
        self.model = self.build_model()
        self.load_model_weights(model_path)

    def build_model(self):
        model = build_lprnet(lpr_max_len=8, class_num=len(self.CHARS), dropout_rate=0.5)
        return model
    ...
    @classmethod
    def recognize_plate(cls, image, model_path='demo_up.pth'):
