...
class Annotator:
    ...
    def __init__(self, im, line_width=None, font_size=None, font=r"G:\yolo-train\yolov5-master\simsun.ttc", pil=False, example="abc"):
        ...
        if self.pil:  # use PIL
            ...
            try:
                font = check_font(r"G:\yolo-train\yolov5-master\simsun.ttc" if non_ascii else font)
    ...
    def box_label(self, box, label="", color=(128, 128, 128), txt_color=(255, 255, 255), rotated=False):
        ...
        if self.pil or not is_ascii(label):
            ...
            if label:
                ...
                self.draw = ImageDraw.Draw(self.im)
                self.font = ImageFont.truetype(r"G:\yolo-train\yolov5-master\simsun.ttc", 30)
